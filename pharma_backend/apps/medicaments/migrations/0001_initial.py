    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forme', models.CharField(choices=[('comprime', 'Comprimé'), ('sirop', 'Sirop'), ('injection', 'Injection'), ('capsule', 'Capsule'), ('pommade', 'Pommade'), ('autre', 'Autre')], max_length=50, verbose_name='Forme galénique')),
                ...
                ('prix_vente', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Prix vente')),
