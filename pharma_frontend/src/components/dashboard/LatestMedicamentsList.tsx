...
export default function LatestMedicamentsList({
  medicaments,
}: LatestMedicamentsListProps) {
  return (
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4 flex-grow min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] sm:text-[11px] font-bold text-[#00877a] lg:text-gray-400 uppercase tracking-wider truncate">
                  {med.dci}
                </p>
              </div>
            </div>
